    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AirlineTicket", x => new { x.AirlinesId, x.TicketsId });
                    table.ForeignKey(
                        name: "FK_AirlineTicket_Airlines_AirlinesId",
                        column: x => x.AirlinesId,
                        principalTable: "Airlines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AirlineTicket_Tickets_TicketsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AirlineTicket_TicketsId",
                table: "AirlineTicket",
                column: "TicketsId");
